# Pomodoro GUI Application - Productivity timer with work/break intervals
from tkinter import *
import math

# Color scheme and timing constants
PINK = "#e2979c"
RED = "#e7305b"
GREEN = "#9bdeac"
YELLOW = "#f7f5dd"
...
def reset_timer():
    # Stop timer and reset all elements to initial state
...
def start_timer():
    # Start the Pomodoro sequence based on current repetition
    global reps
    reps += 1
...
def count_down(count):
    # Update timer display and handle countdown logic
...
# Create canvas with tomato image and timer text
